...
static const char* const SETTINGS_FULLSCREEN_HIDE_INFORMATION = "viv/fullscreen/hide/information";
...
static const char* const SETTINGS_WINDOW_HIDE_INFORMATION = "viv/window/hide/information";
